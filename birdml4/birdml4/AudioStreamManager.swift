...
class AudioStreamManager {
    ...
    private func classifierSetup() {
        ...
        let soundClassifier = try? BirdSongClassifier(configuration: defaultConfig)
        ...
        classifyRequest?.windowDuration = CMTimeMake(value: 5, timescale: 1)
        classifyRequest?.overlapFactor = 0.25
    }
